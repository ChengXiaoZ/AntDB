...
extern Datum mgr_init_gtm_extern(PG_FUNCTION_ARGS);
extern Datum mgr_start_gtm_extern(PG_FUNCTION_ARGS);
...
extern Datum mgr_init_dn_extern(PG_FUNCTION_ARGS);
extern Datum mgr_start_dn_extern(PG_FUNCTION_ARGS);
extern Datum mgr_stop_dn_extern(PG_FUNCTION_ARGS);
